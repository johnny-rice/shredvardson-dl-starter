...
describe('Doctor Metrics JSON', () => {
  it('parses valid LEARNINGS_STATS JSON line', () => {
    const sampleOutput = 'LEARNINGS_STATS={"micro_lessons_total":3,"top10_updated_at":"2025-09-21T16:41:13.235Z","display_guard_violations_last_7d":0}';
    ...
    expect(parsed.top10_updated_at === null || typeof parsed.top10_updated_at === 'string').toBe(true);
  });

  it('handles null timestamp in LEARNINGS_STATS', () => {
    const sampleOutput = 'LEARNINGS_STATS={"micro_lessons_total":0,"top10_updated_at":null,"display_guard_violations_last_7d":0}';
  ...
  it('validates ISO-8601 timestamp format when present', () => {
    const sampleOutput = 'LEARNINGS_STATS={"micro_lessons_total":1,"top10_updated_at":"2025-09-21T16:41:13.235Z","display_guard_violations_last_7d":0}';
