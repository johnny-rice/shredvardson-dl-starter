...
### For AI Agents
1. [SKILLS.md](guides/SKILLS.md) - Understand the Skills system
2. [skills-architecture.md](skills-architecture.md) - Progressive disclosure architecture
3. [../packages/git-context/README.md](../packages/git-context/README.md) - Git context API
4. [SECURE_PROMPTING.md](SECURE_PROMPTING.md) - Security considerations

### For Database Work
1. [DATABASE.md](guides/DATABASE.md) - Complete database guide
2. [database/rls-implementation.md](database/rls-implementation.md) - RLS patterns
3. [database/RLS_OPTIMIZATION.md](database/RLS_OPTIMIZATION.md) - Performance optimization
4. [database/standards.md](database/standards.md) - Standards and conventions

### For Testing
1. [TESTING.md](guides/TESTING.md) - Comprehensive testing guide
2. [testing/TESTING_GUIDE.md](testing/TESTING_GUIDE.md) - Detailed testing documentation
3. [testing/coverage-contract.md](testing/coverage-contract.md) - Coverage requirements
